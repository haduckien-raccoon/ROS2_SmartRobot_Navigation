  ...
  void * untyped_ros_message)
{
  ...
  _ShareMap_Request__ros_msg_type * ros_message = static_cast<_ShareMap_Request__ros_msg_type *>(untyped_ros_message);
  // Field name: topic_name
  {
    std::string tmp;
    cdr >> tmp;
  ...
  void * untyped_ros_message)
{
  ...
  _ShareMap_Response__ros_msg_type * ros_message = static_cast<_ShareMap_Response__ros_msg_type *>(untyped_ros_message);
  // Field name: is_completed
  {
    uint8_t tmp;
    cdr >> tmp;
